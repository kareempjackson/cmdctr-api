    ...
    prisma.agent.create({
      data: {
        ...
        config: {
          ...
          capabilities: ['ticket_analysis', 'solution_suggestion', 'escalation_routing', 'actions'],
    ...
    prisma.agent.create({
      data: {
        ...
        config: {
          ...
          capabilities: ['lead_scoring', 'opportunity_analysis', 'competitive_intelligence', 'actions'],
    ...
    prisma.agent.create({
      data: {
        ...
        config: {
          ...
          capabilities: ['code_generation', 'api_documentation', 'troubleshooting', 'actions'],
    ...
    prisma.agent.create({
      data: {
        ...
        config: {
          ...
          capabilities: ['data_analysis', 'report_generation', 'trend_identification', 'actions'],
